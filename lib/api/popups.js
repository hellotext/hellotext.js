...
var PopupsAPI = /*#__PURE__*/function () {
  ...
  return _createClass(PopupsAPI, null, [{
    ...
    key: "resend",
    value: function () {
      var _resend = _asyncToGenerator(function* (id, submissionId, identity, token) {
      ...
      function resend(_x4, _x5, _x6, _x7) {
    ...
    value: function () {
      ...
      function parsePopupResponse(_x10) {
