...
exports.default = exports.SubmissionsAPI = void 0;
  ...
  _createClass(FormsAPI, null, [{
    ...
    value: function () {
      var _submit = _asyncToGenerator(function* (id, data) {
        return fetch("".concat(this.endpoint, "/").concat(id, "/submissions"), {
          method: 'POST',
          headers: _hellotext.default.headers,
...
FormsAPI.endpoint = 'http://api.lvh.me:3000/v1/public/forms';
var SubmissionsAPI = /*#__PURE__*/_createClass(function SubmissionsAPI() {
  _classCallCheck(this, SubmissionsAPI);
});
exports.SubmissionsAPI = SubmissionsAPI;
SubmissionsAPI.endpoint = "http://api.lvh.me:3000/v1/public/forms/:form_id/submissions";