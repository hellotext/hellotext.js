...
let InputBuilder = exports.InputBuilder = /*#__PURE__*/function () {
    ...
    value: function build(data) {
      ...
      if (['first_name', 'last_name'].includes(data.kind)) {
        ...
        if (data.type === 'email') {
          ...
          input.value = `+${_hellotext.default.business.country.prefix}`;
          input.setAttribute('data-default-value', `+${_hellotext.default.business.country.prefix}`);
        } else {
