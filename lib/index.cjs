...
var _alert_controller = _interopRequireDefault(require("./controllers/alert_controller"));
...
var _popup_controller = _interopRequireDefault(require("./controllers/popup_controller"));
...
application.register('hellotext--alert', _alert_controller.default);
application.register('hellotext--form', _form_controller.default);
application.register('hellotext--popup', _popup_controller.default);
...
var _default = exports.default = _hellotext.default;