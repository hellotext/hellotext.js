  ...
  _createClass(_default, [{
    ...
    value: function () {
      var _submit = _asyncToGenerator(function* (e) {
        ...
        var response = yield _api.default.forms.submit(this.form.id, Object.fromEntries(formData));
        console.log(response, yield response.json());
...
_default.targets = ['inputContainer', 'input', 'button'];