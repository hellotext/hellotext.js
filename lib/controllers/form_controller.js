  ...
  _createClass(_default, [
    ...
    },
    {
      ...
      value: function revealOTPContainer(submissionId) {
        var paragraph = this.requiredInputs.find(input => input.name === 'email')
          ? _hellotext.default.business.locale.otp.sent_to_email
          : _hellotext.default.business.locale.otp.sent_to_phone
    ...
    },
    {
      ...
      value: function completed(_ref) {
        ...
        _hellotext.default.setSession(detail.sessionId)
        this.element.remove()
      },
