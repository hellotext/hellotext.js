...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function revealOTPContainer(submissionId) {
      var paragraph = this.requiredInputs.find(input => input.name === 'email') ? 'A One-Time Password has been sent to your email address' : 'An One-Time Password has been sent to your phone number';
      var otpContainer = this.form.buildOTPContainer(submissionId, paragraph);
      this.element.appendChild(otpContainer);
    }
  }, {
    key: "completed",
    value: function completed(_ref) {
      var {
        detail
      } = _ref;
      this.form.save();
