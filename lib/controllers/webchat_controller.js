  ...
  _createClass(_default, [{
    ...
    value: function onFileInputChange() {
      ...
      if (true || fileMaxSizeTooMuch) {
        ...
        var errorMessage = this.fileSizeErrorMessageValue.replace('%{limit}', this.byteToMegabyte(this.mediaValue[mediaType].max_size));
...
_default.targets = ['trigger', 'popover', 'input', 'attachmentInput', 'attachmentButton', 'errorMessageContainer'];