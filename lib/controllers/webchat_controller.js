...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "createAttachmentElementFromTemplate",
    value: function createAttachmentElementFromTemplate(data) {
      var element = this.attachmentElement();
      ...
      input.type = 'hidden';
      input.name = "".concat(this.inputNameValue, "[signed_id]");
...
_default.targets = ['trigger', 'popover', 'input', 'attachmentInput', 'attachmentButton', 'errorMessageContainer', 'attachmentTemplate', 'attachmentContainer'];