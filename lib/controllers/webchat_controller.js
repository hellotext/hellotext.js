...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function onMessageInputKeydown(event) {
      var hasContent = event.target.value.trim() !== '';
    ...
    value: function resizeInput() {
      ...
      var clone = this.inputTarget.cloneNode(true);
      ...
      var contentScrollHeight = clone.scrollHeight;
      clone.remove();
      ...
      var newHeight = Math.max(this.initialHeight, contentScrollHeight);
      var finalHeight = Math.min(newHeight, maxHeight);

      // 4. Apply the calculated height.
      this.inputTarget.style.height = "".concat(finalHeight, "px");
    }
  }, {
    key: "sendMessage",
    value: function () {
