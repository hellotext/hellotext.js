...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "quickReply",
    value: function quickReply(_ref) {
      var {
        currentTarget
      } = _ref;
    ...
    value: function getScrollAmount() {
      ...
      var firstCard = this.containerTarget.querySelector('.message__carousel_card');
      if (!firstCard) {
    ...
    value: function updateFades() {
      ...
      var maxScroll = this.containerTarget.scrollWidth - this.containerTarget.clientWidth;
...
_default.targets = ['container', 'leftFade', 'rightFade', 'carouselCard'];
