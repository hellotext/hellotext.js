...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function interpolateCompletionCopy() {
      var identity = this.completionIdentity;
      if (!identity) return;
      var replacements = {
    ...
    value: function configureCompletionActions() {
      ...
      if (this.submissionId && this.submissionActionToken && this.submissionVerificationState === 'unverified' && this.hasResendButtonTarget) {
    ...
    value: function () {
      var _resend = _asyncToGenerator(function* (event) {
        ...
        try {
          ...
          var response = yield API.popups.resend(this.idValue, this.submissionId, identity.kind, this.submissionActionToken);
    ...
    value: function () {
      var _changeDestination = _asyncToGenerator(function* (event) {
        var _this$completionIdent;
        if (event) event.preventDefault();
        var input = (_this$completionIdent = this.completionIdentity) === null || _this$completionIdent === void 0 ? void 0 : _this$completionIdent.input;
        if (!input) return;
