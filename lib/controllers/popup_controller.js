...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function () {
      var _submit = _asyncToGenerator(function* (event) {
        ...
        try {
          ...
          var response = yield PopupsAPI.submit(this.idValue, payload, this.idempotencyKeyFor(payload));
          if (response.failed) {
    ...
    value: function configureCompletionActions() {
      var deliveryRequired = this.submissionDeliveryStatus !== 'not_required';
    ...
    value: function () {
      var _resend = _asyncToGenerator(function* (event) {
        ...
        try {
          ...
          var response = yield PopupsAPI.resend(this.idValue, this.submissionId, this.submissionActionToken);
    ...
    value: function () {
      var _changeDestination = _asyncToGenerator(function* (event) {
        ...
        try {
          var response = yield PopupsAPI.cancel(this.idValue, this.submissionId, this.submissionActionToken);
    ...
    key: "revealCompletionCopy",
    value: function revealCompletionCopy(deliveryRequired) {
...
_default.targets = ['bubble', 'dialog', 'step', 'completed', 'input', 'submitButton', 'globalError', 'resendButton', 'changeDestinationButton', 'deliveryCopy', 'noDeliveryCopy'];
_default.values = {
  capture: Object,
  device: String,
  hasBubble: Boolean,
