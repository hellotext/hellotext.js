...
var EventEmitter = /*#__PURE__*/function () {
  ...
  _createClass(EventEmitter, [{
    ...
    value: function addSubscriber(eventName, callback) {
      this.subscribers = _objectSpread(_objectSpread({}, this.subscribers), {}, _defineProperty({}, eventName, this.subscribers[eventName] ? [].concat(_toConsumableArray(this.subscribers[eventName]), [callback]) : [callback]));
    }
  }, {
