    ...
    function () {
      var _initialize = _asyncToGenerator(function* (business, config) {
        ...
        if (_core.Configuration.session) {
          ...
          if (_core.Configuration.webchat.isSet) {
          ...
          _classPrivateFieldLooseBase(this, _mintAnonymousSession)[_mintAnonymousSession]().then( /*#__PURE__*/function () {
            var _ref = _asyncToGenerator(function* (response) {
              _classPrivateFieldLooseBase(_this, _session)[_session] = _models.Cookies.set('hello_session', response.id);
              if (_core.Configuration.webchat.isSet) {
                _this.webchat = yield _models.Webchat.load(_core.Configuration.webchat.id);
              }
            });
            return function (_x3) {
