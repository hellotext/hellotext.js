  ...
  _createClass(Hellotext, null, [{
    ...
    function initialize(business, config) {
      ...
      if (_core.Configuration.session) {
        ...
        _classPrivateFieldLooseBase(this, _session)[_session] = crypto.randomUUID();
        _models.Cookies.set('hello_session', crypto.randomUUID());
      }
    }
  }, {
    key: "setSession",
    value: function setSession(value) {
      ...
      _models.Cookies.set('hello_session', value);
    }
    ...
    value: function () {
      var _track = _asyncToGenerator(function* (action) {
        ...
        if (_classPrivateFieldLooseBase(this, _query)[_query].inPreviewMode) return Promise.resolve();
