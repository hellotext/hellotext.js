...
function _setSessionCookie2() {
  ...
  if (this.eventEmitter.listeners) {
    this.eventEmitter.emit("session-set", _classPrivateFieldLooseBase(this, _session)[_session]);
  }
...
Hellotext.__apiURL = 'http://api.lvh.me:3000/v1/';
...
Hellotext.eventEmitter = new _eventEmitter.default();
