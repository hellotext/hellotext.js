  ...
  _createClass(Hellotext, null, [{
    ...
    function () {
      var _initialize = _asyncToGenerator(function* (business) {
        ...
        var popupConfig = this.deepMergePlainObjects(businessData === null || businessData === void 0 ? void 0 : businessData.popup, config.popup);
        var webchatConfig = this.mergeWebchatConfig(businessData === null || businessData === void 0 ? void 0 : businessData.webchat, config.webchat);
        var whatsappConfig = this.mergeWhatsAppConfig(businessData === null || businessData === void 0 ? void 0 : businessData.whatsapp, config.whatsappWidget);
        ...
        if (config.popup !== false && popupConfig.id) {
          ...
          widgetLoads.push(Popup.load(popupConfig.id).then(popup => {
            this.popup = popup;
          }));
        }
        yield Promise.all(widgetLoads);
