      ...
      value:
        ...
        function initialize(business) {
          ...
          if (_classPrivateFieldLooseBase(this, _query)[_query].session) {
            _classPrivateFieldLooseBase(this, _session)[_session] = _models.Cookies.set(
              'hello_session',
              _classPrivateFieldLooseBase(this, _query)[_query].session,
            )
          } else if (config.autogenerateSession) {
            _classPrivateFieldLooseBase(this, _mintAnonymousSession)
              [_mintAnonymousSession]()
              .then(response => {
                _classPrivateFieldLooseBase(this, _session)[_session] = _models.Cookies.set(
                  'hello_session',
                  response.id,
