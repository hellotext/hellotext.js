...
var Form = /*#__PURE__*/ (function () {
  function Form(data) {
    ...
    this.element =
      element ||
      document.querySelector('[data-hello-form="'.concat(this.id, '"]')) ||
  ...
  _createClass(Form, [
    ...
    },
    {
      ...
      value: function buildHeader(header) {
        var headerElement = _classPrivateFieldLooseBase(this, _findOrCreateComponent)[
          _findOrCreateComponent
    ...
    },
    {
      ...
      value: function buildInputs(inputs) {
        var inputsContainerElement = _classPrivateFieldLooseBase(this, _findOrCreateComponent)[
          _findOrCreateComponent
        ]('[data-form-inputs]', 'main')
    ...
    },
    {
      ...
      value: function buildButton(button) {
        var buttonElement = _classPrivateFieldLooseBase(this, _findOrCreateComponent)[
          _findOrCreateComponent
    ...
    },
    {
      ...
      value: function buildFooter(footer) {
        var element = _classPrivateFieldLooseBase(this, _findOrCreateComponent)[
          _findOrCreateComponent
        ]('[data-form-footer]', 'footer')
