  ...
  _createClass(Form, [{
    ...
    value: function buildInputs(inputs) {
      ...
      if (this.element.querySelector('[data-form-inputs]')) {
        ...
        this.element.querySelector('[data-form-header]').insertAdjacentHTML('afterend', this.element.querySelector('[data-form-header]'));
      }
    }
  }, {
    key: "buildButton",
    value: function buildButton(button) {
      ...
      if (this.element.querySelector('[data-form-button]')) {
        ...
        this.element.querySelector('[data-form-inputs]').insertAdjacentHTML('afterend', buttonElement);
      }
    }
  }, {
    key: "buildFooter",
...
function _findOrCreateComponent2(selector, tag) {
  ...
  return ((_this$element$querySe = this.element.querySelector(selector)) === null || _this$element$querySe === void 0 ? void 0 : _this$element$querySe.cloneNode(true)) || document.createElement(tag);
}