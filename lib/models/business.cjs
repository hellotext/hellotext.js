 ...
 */
let Business = exports.Business = /*#__PURE__*/function () {
  /**
  ...
  return _createClass(Business, [{
    ...
    value: async function hydrate({
      ...
      try {
        const response = apiRoot ? await _businesses.default.get(this.id, apiRoot) : await _businesses.default.get(this.id);
