...
class FormCollection {
  constructor() {
    this.forms = [];
    this.visitBusinessId = _hellotext.default.visitBusinessId;
    this.initializationVersion = _hellotext.default.initializationVersion;
  ...
  async collect() {
    ...
    try {
      ...
      _hellotext.default.eventEmitter.dispatch('forms:collected', this);
  ...
  add(data) {
    ...
    this.forms.push(new _form.Form(data, null, this.visitBusinessId));
  }
  getById(id) {
  ...
  get current() {
    return _hellotext.default.visitBusinessId === this.visitBusinessId && _hellotext.default.initializationVersion === this.initializationVersion;
  }
  get #formIdsToFetch() {
