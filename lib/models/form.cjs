...
class Form {
  constructor(data, element = null, visitBusinessId = _hellotext.default.visitBusinessId) {
    this.data = data;
  ...
  markAsCompleted(data) {
    ...
    if (_hellotext.default.visitBusinessId === this.visitBusinessId) _hellotext.default.recordActivity('form.completed');
