...
var FormCollection = /*#__PURE__*/function () {
  ...
  _createClass(FormCollection, [{
    ...
    value: function formMutationObserver(mutationsList, observer) {
      var mutation = mutationsList.find(mutation => mutation.type === 'childList' && mutation.addedNodes.length > 0);
      if (!mutation) return;
