...
let NotInitializedError = exports.NotInitializedError = /*#__PURE__*/function (_Error) {
  function NotInitializedError() {
    var _this;
    _classCallCheck(this, NotInitializedError);
    _this = _callSuper(this, NotInitializedError, ['You need to initialize before tracking events. Call Hellotext.initialize and pass your public business id']);
