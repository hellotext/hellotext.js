...
let Hellotext = /*#__PURE__*/function () {
  ...
  _createClass(Hellotext, null, [{
    ...
    async function initialize(business, config = {}) {
      ...
      const popupConfig = this.deepMergePlainObjects(businessData === null || businessData === void 0 ? void 0 : businessData.popup, config.popup);
      const webchatConfig = this.mergeWebchatConfig(businessData === null || businessData === void 0 ? void 0 : businessData.webchat, config.webchat);
      const whatsappConfig = this.mergeWhatsAppConfig(businessData === null || businessData === void 0 ? void 0 : businessData.whatsapp, config.whatsappWidget);
      ...
      if (config.popup !== false && popupConfig.id) {
        ...
        widgetLoads.push(_models.Popup.load(popupConfig.id).then(popup => {
          this.popup = popup;
        }));
      }
