...
Event.events = ['session-set', 'utm-set', 'forms:collected', 'form:completed', 'popup:opened', 'popup:closed', 'webchat:mounted', 'webchat:opened', 'webchat:closed', 'webchat:message:sent', 'webchat:message:received', 'cart.added'];