...
class Event {
  static events = ['session-set', 'utm-set', 'forms:collected', 'form:completed', 'alert:shown', 'alert:dismissed', 'alert:accepted', 'activity:occurred', 'popup:opened', 'popup:closed', 'webchat:mounted', 'webchat:opened', 'webchat:closed', 'webchat:message:sent', 'webchat:message:received', 'cart.added'];
  static valid(name) {
