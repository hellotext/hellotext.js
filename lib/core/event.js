...
export default class Event {
  static events = ['session-set', 'utm-set', 'forms:collected', 'form:completed', 'popup:mounted', 'popup:opened', 'popup:closed', 'alert:shown', 'alert:dismissed', 'alert:accepted', 'activity:occurred', 'webchat:mounted', 'webchat:opened', 'webchat:closed', 'webchat:message:sent', 'webchat:message:received', 'cart.added'];
  static valid(name) {
