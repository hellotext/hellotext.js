...
class Popup {
  ...
  constructor(data, { container = Configuration.popup.container, shouldMount = () => true } = {}) {
    this.data = data
  ...
  async render() {
    ...
    if (!container) {
      console.warn(
        `Hellotext popup was not mounted because the container ${this.container} was not found.`,
      )
      return false
    }
